...
void main() {
  ...
  group('StatusTag', () {
    testWidgets('renders status code text', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(body: StatusTag(statusCode: 200)),
      ));
    ...
    testWidgets('uses warning color for 4xx', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(body: StatusTag(statusCode: 404)),
      ));
    ...
    testWidgets('uses danger color for 5xx', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(body: StatusTag(statusCode: 500)),
      ));
    ...
    testWidgets('uses info color for 3xx', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(body: StatusTag(statusCode: 301)),
      ));
  ...
  group('ClickCursor', () {
    testWidgets('renders child widget', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: ClickCursor(child: Text('Click me')),
        ),
      ));
  ...
  group('SidebarRow', () {
    testWidgets('renders title text', (tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          body: SidebarRow(title: const Text('My Item')),
        ),
      ));
