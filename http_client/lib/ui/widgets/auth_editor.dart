              ...
              child: Column(
                children: [
                  TextField(
                    ...
                    controller:
                        _controller('basic.user', a.username),
                    onChanged: (v) => widget.onChanged(a.copyWith(
                        username: v)),
                  ),
                  ...
                  TextField(
                    ...
                    obscureText: true,
                    controller:
                        _controller('basic.pass', a.password),
                    onChanged: (v) => widget.onChanged(a.copyWith(
                        password: v)),
                  ),
                ],
